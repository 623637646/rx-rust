...
#[test]
fn test_completed_both_empty_first_next() {
    let (mut sender, observable, channel_checker) = test_channel();
    let (mut sender_1, observable_1, channel_checker_1) = test_channel();
    let (checker, observer) = Checker::new();
...
#[test]
fn test_completed_both_empty_second_next() {
    let (mut sender, observable, channel_checker) = test_channel();
    let (mut sender_1, observable_1, channel_checker_1) = test_channel();
    let (checker, observer) = Checker::new();
    ...
    assert!(sender_1.on_next(333).is_stop());
    assert_eq!(checker.values(), [false]);
    assert_eq!(checker.state(), State::Completed);
    assert_eq!(channel_checker.state(), ChannelState::Completed);
...
#[test]
fn test_completed_first_some_completed_second_next_same() {
    let (mut sender, observable, channel_checker) = test_channel();
    let (mut sender_1, observable_1, channel_checker_1) = test_channel();
    let (checker, observer) = Checker::new();
...
#[test]
fn test_completed_first_some_completed_second_next_different() {
    let (mut sender, observable, channel_checker) = test_channel();
    let (mut sender_1, observable_1, channel_checker_1) = test_channel();
    let (checker, observer) = Checker::new();
    ...
    assert!(sender_1.on_next(444).is_stop());
    assert_eq!(checker.values(), [false]);
    assert_eq!(checker.state(), State::Completed);
    assert_eq!(channel_checker.state(), ChannelState::Completed);
    assert_eq!(channel_checker_1.state(), ChannelState::Unsubscribed);
...
#[test]
fn test_completed_second_some_completed_first_next_same() {
    let (mut sender, observable, channel_checker) = test_channel();
    let (mut sender_1, observable_1, channel_checker_1) = test_channel();
    let (checker, observer) = Checker::new();
...
#[test]
fn test_completed_second_some_completed_first_next_different() {
    let (mut sender, observable, channel_checker) = test_channel();
    let (mut sender_1, observable_1, channel_checker_1) = test_channel();
    let (checker, observer) = Checker::new();
...
#[test]
fn test_completed_with_different() {
    ...
    assert!(sender_1.on_next(222).is_stop());
    assert_eq!(checker.values(), [false]);
    assert_eq!(checker.state(), State::Completed);
    assert_eq!(channel_checker.state(), ChannelState::Unsubscribed);
    assert_eq!(channel_checker_1.state(), ChannelState::Unsubscribed);
...
fn test_mut_ref() {
    ...
    assert!(sender_1.on_next(&mut value_3).is_stop());
...
fn test_lifetime_or_sub() {
...

    {
        ...
        let observable = observable.sequence_equal(boundary);
