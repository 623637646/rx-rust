...
use rx_rust::operators::mathematical_aggregate::min::Min;
use rx_rust::{
...
fn test_unsub_on_next_by_take() {
    ...
    // Custom operations
    let observable = observable.min().take(1);
...
fn test_unsub_on_next_by_take_2() {
    ...
    // Custom operations
    let observable = observable.take(1).min();
...
fn test_multiple_operation() {
    ...
    // Custom operations
    let observable = observable.min().min();
...
fn test_without_convenient_api() {
    ...
    // Custom operations
    let observable = Min::new(observable);
