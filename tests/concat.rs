...
fn test_completed_inner_finish() {
    ...
    assert!(checker.is_values_matched(&[111, 333, 444]));
    assert!(checker.is_active());
...
fn test_completed_new_from_iter() {
    ...
    // Custom operations
    let observable = Concat::new_from_iter([subject_1.clone(), subject_2.clone()]);
...
fn test_unsubscribe() {
    ...
    assert!(checker_2.is_values_matched(&[111, 333]));
    assert!(checker_2.is_active());
    ...
    assert!(checker_1.is_values_matched(&[111]));
    assert!(checker_1.is_dropped());
    assert!(checker_2.is_values_matched(&[111, 333, 444]));
    assert!(checker_2.is_active());
...
fn test_ref() {
    ...
    assert!(checker.is_values_matched(&[&value_1, &value_3]));
    assert!(checker.is_active());
    ...
    assert!(checker.is_values_matched(&[&value_1, &value_3, &value_4]));
    assert!(checker.is_active());
...
fn test_subscribe_by_different_observer() {
    ...
    subject_1.on_next(333);
    assert!(checker_1.is_values_matched(&[111, 333]));
    assert!(checker_1.is_active());
    assert!(checker_2.is_values_matched(&[111, 333]));
    assert!(checker_2.is_active());
    ...
    subject_2.on_next(444);
    assert!(checker_1.is_values_matched(&[111, 333, 444]));
    assert!(checker_1.is_active());
    assert!(checker_2.is_values_matched(&[111, 333, 444]));
    assert!(checker_2.is_active());
