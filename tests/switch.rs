...
fn test_completed_inner_finish() {
    ...
    assert!(checker.is_values_matched(&[111, 222, 444]));
    assert!(checker.is_active());
...
fn test_completed_new_from_iter() {
    ...
    subject_2.on_next(444);
    assert!(checker.is_values_matched(&[222, 444]));
    assert!(checker.is_active());
...
fn test_unsubscribe() {
    ...
    assert!(checker_1.is_values_matched(&[111, 222]));
    assert!(checker_1.is_dropped());
    assert!(checker_2.is_values_matched(&[111, 222, 444]));
    assert!(checker_2.is_active());
...
fn test_ref() {
    ...
    assert!(checker.is_values_matched(&[&value_1, &value_2, &value_4]));
    assert!(checker.is_active());
...
fn test_subscribe_by_different_observer() {
    ...
    subject_2.on_next(444);
    assert!(checker_1.is_values_matched(&[111, 222, 444]));
    assert!(checker_1.is_active());
    assert!(checker_2.is_values_matched(&[111, 222, 444]));
    assert!(checker_2.is_active());
