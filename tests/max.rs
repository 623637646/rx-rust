...
use rx_rust::operators::mathematical_aggregate::max::Max;
use rx_rust::{
...
fn test_subscribe_by_different_observer() {
    ...
    assert_eq!(checker_1.values(), [4]);
    assert_eq!(checker_1.state(), State::Completed);
    assert_eq!(checker_2.values(), [4]);
...
fn test_unsub_on_next_by_take() {
    ...
    // Custom operations
    let observable = observable.max().take(1);
...
fn test_unsub_on_next_by_take_2() {
    ...
    // Custom operations
    let observable = observable.take(1).max();
...
fn test_multiple_operation() {
    ...
    // Custom operations
    let observable = observable.max().max();
...
fn test_without_convenient_api() {
    ...
    // Custom operations
    let observable = Max::new(observable);
