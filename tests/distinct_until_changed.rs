...
fn test_completed() {
    ...
    assert!(sender.on_next(111).is_continue());
    assert_eq!(checker.values(), [111, 222, 111]);
    assert_eq!(checker.state(), State::Active);
    assert_eq!(channel_checker.state(), ChannelState::Subscribed);
...
fn test_completed_with_key_selector() {
    ...
    assert!(sender.on_next("a").is_continue());
    assert_eq!(checker.values(), ["a"]);
    assert_eq!(checker.state(), State::Active);
    assert_eq!(channel_checker.state(), ChannelState::Subscribed);

    assert!(sender.on_next("b").is_continue());
    assert_eq!(checker.values(), ["a"]);
    assert_eq!(checker.state(), State::Active);
    assert_eq!(channel_checker.state(), ChannelState::Subscribed);

    assert!(sender.on_next("cc").is_continue());
    assert_eq!(checker.values(), ["a", "cc"]);
    assert_eq!(checker.state(), State::Active);
    assert_eq!(channel_checker.state(), ChannelState::Subscribed);

    assert!(sender.on_next("d").is_continue());
    assert_eq!(checker.values(), ["a", "cc", "d"]);
    assert_eq!(checker.state(), State::Active);
    assert_eq!(channel_checker.state(), ChannelState::Subscribed);
...
fn test_unsubscribe() {
    ...
    assert_eq!(checker_1.values(), [111]);
    assert_eq!(checker_1.state(), State::Dropped);
    assert_eq!(checker_2.values(), [111, 222, 111]);
    assert_eq!(checker_2.state(), State::Active);
...
fn test_ref() {
    ...
    assert!(sender.on_next(&value_1).is_continue());
    assert_eq!(checker.values(), [&value_1, &value_2, &value_1]);
    assert_eq!(checker.state(), State::Active);
    assert_eq!(channel_checker.state(), ChannelState::Subscribed);
...
fn test_mut_ref() {
    ...
    assert!(sender.on_next(&mut value_1_1).is_continue());
    assert_eq!(checker.values(), [111]);
    assert_eq!(checker.state(), State::Active);
    assert_eq!(channel_checker.state(), ChannelState::Subscribed);
    ...
    assert!(sender.on_next(&mut value_1_2).is_continue());
    assert_eq!(checker.values(), [111, 222, 111]);
    assert_eq!(checker.state(), State::Active);
    assert_eq!(channel_checker.state(), ChannelState::Subscribed);
